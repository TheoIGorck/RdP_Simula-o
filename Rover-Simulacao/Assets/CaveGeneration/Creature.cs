    ...
    public class Creature: ScriptableObject
    {
        ...
        private void CreateCreature()
        {
            ...
            while (i < cellsAlive.Count)
            {
                ...
                gob.transform.position = new Vector3(cellsAlive[i].Lin ,cellsAlive[i].Hei - 3 + 3,cellsAlive[i].Col);
                i++;
            }
        }
        private void UpdateCreature()
        {
            ...
            while (i < cellsAlive.Count)
            {
                creatureGo[i].transform.position = new Vector3(cellsAlive[i].Lin ,cellsAlive[i].Hei - 3 + 4,cellsAlive[i].Col);
